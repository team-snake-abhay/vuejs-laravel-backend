    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown user-menu">
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
          <img src="{{url('storage/images/users',Auth::user()->image)}}" class="user-image img-circle elevation-2" alt="User Image">
          <span class="d-none d-md-inline">{{Auth::user()->name}}</span>
        </a>
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <!-- User image -->
          <li class="user-header bg-primary">
            <img src="{{url('storage/images/users',Auth::user()->image)}}" class="img-circle elevation-2" alt="User Image">
          ...
          <li class="user-footer">
            <a href="{{url('manage/profile')}}" class="btn btn-default btn-flat">Profile</a>
