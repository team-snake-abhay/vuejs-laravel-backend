        ...
        <div class="card-body">
            <div class="row">
                <div class="col-xs-12 col-md-6">
                    ...
                    <input class="form-control" id="name" name="name" type="text" value="{{ old('name') }}" autocomplete="off">
                ...
                <div class="col-xs-12 col-md-3">
                    ...
                    <input class="form-control" id="mobile" name="mobile" type="text" value="{{ old('mobile') }}" autocomplete="off">
            ...
            <div class="row">
                <div class="col-xs-12 col-md-3">
                    ...
                    <input class="form-control" id="email" name="email" type="email" value="{{ old('email') }}" autocomplete="off">
                ...
                <div class="col-xs-12 col-md-3">
                    ...
                    <input class="form-control" id="password" name="password" type="text" value="{{ old('password') }}" autocomplete="off">
