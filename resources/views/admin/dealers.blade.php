...
<form role="form" method="POST" enctype="multipart/form-data" id="addEditForm">
    {{ csrf_field() }}
    <input type="hidden" id="dealer_id" name="id" value="{{old('id')}}">
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title">Dealer Information Management</h3>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-xs-12 col-md-3">
                    <label for="nid">Trade License No</label>
                    <input class="form-control" id="nid" name="nid" type="text" value="{{old('nid')}}"
                        autocomplete="off">
                    @if ($errors->has('nid'))
                    <span class="text-danger">
